...
// Matches API_USAGE.md Scenario 1: no QR code, all fields unverified.
export const confirmedCard: CardResponse = {
  ...
  fields: {
    ...
    email: {
      value: "jane@acme.com",
      status: "unverified",
      ocr_llm_value: "jane@acme.com",
      qr_value: null,
    },
    phone: {
      value: "+1-555-0100",
      status: "unverified",
      ocr_llm_value: "+1-555-0100",
      qr_value: null,
    },
  },
...
// Matches API_USAGE.md Scenario 3: QR disagrees with OCR on `company`.
export const needsReviewCard: CardResponse = {
...
export const resolvedCard: CardResponse = {
  ...needsReviewCard,
  status: "confirmed",
  fields: {
